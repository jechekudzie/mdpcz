            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Newsletters</h4>
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <a href="{{url('/admin/newsletter/create')}}" class="btn btn-info add-btn"><i
                                            class="ri-add-fill me-1 align-bottom"></i> Add Newsletter
                                    </a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table align-middle table-nowrap mb-0">
                                        ...
                                        @foreach($newsletters as $newsletter)
                                            <tr>
                                                ...
                                                <td class="owner">{{$newsletter->title}}</td>
                                                <td class="owner"><a href="{{url($newsletter->file)}}" target="_blank">file</a>
                                                </td>
                                                <td>
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            title="View">
                                                            <a href="{{url($newsletter->file)}}" target="_blank"
