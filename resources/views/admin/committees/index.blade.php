                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item committeeive">Committees</li>
                            </ol>
                        </div>
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <a href="{{url('/admin/committee/create')}}" class="btn btn-info add-btn"><i
                                            class="ri-add-fill me-1 align-bottom"></i> Add committee
                                    </a>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <td>
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            title="View">
                                                            <a href="{{url('/admin/committee/'.$committee->id)}}"
                                                        ...
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            <a class="edit-item-btn"
                                                               href="{{url('/admin/committee/'.$committee->id.'/edit')}}">Edit</a>
                                                        </li>
                                                    </ul>
                                                </td>
                                            </tr>
