                ...
                <div class="col-xxl-9">
                    <div class="card" id="companyList">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{url('/admin/complaint')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6">
                                            <div>
                                                <label for="companyname-field"
                                                       class="form-label">Complaint name</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div>
                                                <label for="companyname-field"
                                                       class="form-label">Complaint subject</label>
                                ...
                                <div class="modal-footer">
                                    <div class="hstack gap-2 justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-success" id="add-btn">Add complaint
                                        </button>
