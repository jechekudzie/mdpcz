            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Strategic goals</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">CRM</a></li>
                                <li class="breadcrumb-item strategic_goalive">Strategic goals</li>
                            </ol>
                        </div>
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <a href="{{url('/admin/strategic_goal')}}" class="btn btn-info add-btn"><i
                            ...
                            <div class="col-xxl-9">
                                <div class="card" id="companyList">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="{{url('/admin/strategic_goal/'.$strategic_goal->id)}}"
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div>
                                                            ...
                                                            <input type="text" name="period" class="form-control"
                                                                   value="{{$strategic_goal->period}}" required/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div>
                                                            ...
                                                            <textarea name="description" class="form-control" id="editor"
                                                                      required>{!! $strategic_goal->description !!}</textarea>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="modal-footer">
                                                <div class="hstack gap-2 justify-content-end">
                                                    ...
                                                    <button type="submit" class="btn btn-success" id="add-btn">Update strategic_goal
                                                    </button>
