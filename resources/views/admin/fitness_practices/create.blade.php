                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Fitness to practice</li>
                            </ol>
                        </div>
                ...
                <div class="col-xxl-9">
                    <div class="card" id="companyList">
                        <div style="color: black;font-size: 18px;font-weight: bolder;" class="card-header">
                            Add fitness to practice
                        </div>

                        <div class="card-body">

                            <form method="post" action="{{url('/admin/fitness_practice')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="modal-footer">
                                    <div class="hstack gap-2 justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-success" id="add-btn">Add fitness to practice
                                        </button>
