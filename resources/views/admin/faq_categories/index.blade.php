            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Faqs Categories</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">CRM</a></li>
                                <li class="breadcrumb-item registrarive">Faqs Categories</li>
                            </ol>
                        </div>
                            ...
                            <div class="col-sm-auto {{--ms-auto--}}">
                                <div class="list-grid-nav hstack gap-1">
                                    ...
                                    <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#addmembers">
                                        <i class="ri-add-fill me-1 align-bottom"></i> Add Faqs Category
                                    </button>
                                </div>
                            </div>
                            <!--end col-->
                                ...
                                <table class="table align-middle table-nowrap mb-0">
                                    ...
                                    @foreach($faq_categories as $faq_category)
                                        <tr>
                                            ...
                                            <td class="owner">{{$faq_category->name}}</td>
                                            <td class="owner"><a href="{{url('/admin/faq/'.$faq_category->id.'/index')}}">Faqs ({{$faq_category->faqs->count()}})</a></td>
                                            </td>
                                            <td>
                                                <ul class="list-inline hstack gap-2 mb-0">
                                                    <li class="list-inline-item" data-bs-toggle="tooltip"
                                                        ...
                                                        <a class="edit-item-btn"
                                                           href="{{url('/admin/faq_category/'.$faq_category->id.'/edit')}}">Edit</a>
                                                    </li>
                                                </ul>
                                            </td>
                                        </tr>
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="{{url('/admin/faq_category')}}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="hstack gap-2 justify-content-end">
                                                            ...
                                                            <button type="submit" class="btn btn-success">Add Faqs Category
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
