                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <a href="{{url('/admin/council_structure')}}" class="btn btn-info add-btn"><i
                            ...
                            <div class="col-xxl-9">
                                <div class="card" id="companyList">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="{{url('/admin/council_structure/'.$councilStructure->id)}}"
                                              enctype="multipart/form-data">
                                            @method('PATCH')
                                            @csrf
                                            <div class="row">

                                                <img style="width: 200px" src="{{asset($councilStructure->file)}}"/>
                                                <br/>
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                ...
                                                <div class="col-lg-12">
                                                    <div>
                                                        <label for="companyname-field"
                                                               class="form-label">Council Structure</label>
                                                        <textarea name="description" class="form-control"
                                                                  id="editor">{!! $councilStructure->description !!}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="hstack gap-2 justify-content-end">
                                                        ...
                                                        <button type="submit" class="btn btn-success">Edit Council structure
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
