                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Council structure</li>
                            </ol>
                        </div>
                ...
                <div class="col-xxl-9">
                    <div class="card" id="companyList">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{url('/admin/council_structure')}}" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="col-lg-12">
                                            <div>
                                                <label for="companyname-field"
                                                       class="form-label">Council structure Organogram</label>
                                ...
                                <div class="modal-footer">
                                    <div class="hstack gap-2 justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-success" id="add-btn">Add council_structure
                                        </button>
