            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Registrars</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">CRM</a></li>
                                <li class="breadcrumb-item registrarive">Registrars</li>
                            </ol>
                        </div>
                            ...
                            <div class="col-sm-auto {{--ms-auto--}}">
                                <div class="list-grid-nav hstack gap-1">
                                    ...
                                    <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#addmembers">
                                        <i class="ri-add-fill me-1 align-bottom"></i> Add Registrar
                                    </button>
                                </div>
                            </div>
                            <!--end col-->
                                    ...
                                    <div class="col">
                                        <div class="card team-box">
                                            <div class="team-cover">
                                                <img src="{{asset($registrar->file)}}" alt="" class="img-fluid"/>
                                            </div>
                                            <div class="card-body p-4">
                                                <div class="row align-items-center team-row">
                                                    ...
                                                    <div class="col-lg-4 col">
                                                        <div class="team-profile-img">
                                                            <div
                                                                ...
                                                                <img src="{{asset($registrar->file)}}" alt=""
                                                                     class="img-fluid d-block rounded-circle"/>
                                                            </div>
                                                            <div class="team-content">
                                                                <a data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                                   aria-controls="offcanvasExample">
                                                                    <h5 class="fs-16 mb-1">{{$registrar->name}}</h5>
                                                                </a>
                                                                <p class="text-muted mb-0">{{$registrar->title}}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2 col">
                                                        <div class="text-end">
                                                            <a href="{{url('/admin/registrar/'.$registrar->id.'/edit')}}" class="btn btn-light view-btn">View
                                                                Profile
                                                            </a>
                                                        </div>
                                                    </div>
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="myModalLabel">Add New Registrar</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <form method="post" action="{{url('/admin/registrar')}}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                                            <label for="designation"
                                                                   class="form-label">Qualifications</label>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div>
                                                            <label for="companyname-field"
                                                                   class="form-label">Registrar Bio</label>
                                                            <textarea name="bio" class="form-control" id="editor"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="hstack gap-2 justify-content-end">
                                                            ...
                                                            <button type="submit" class="btn btn-success">Add Registrar
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
