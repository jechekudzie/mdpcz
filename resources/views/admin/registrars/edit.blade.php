            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Registrar</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">CRM</a></li>
                                <li class="breadcrumb-item registrarive">Registrar</li>
                            </ol>
                        </div>
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <a href="{{url('/admin/registrar')}}" class="btn btn-info add-btn"><i
                            ...
                            <div class="col-xxl-9">
                                <div class="card" id="companyList">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="{{url('/admin/registrar/'.$registrar->id)}}"
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="qualifications"
                                                               value="{{$registrar->qualifications}}">
                                                    </div>
                                                </div>

                                                <img style="width: 200px" src="{{asset($registrar->file)}}"/>
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                ...
                                                <div class="col-lg-12">
                                                    <div>
                                                        ...
                                                        <textarea name="bio" class="form-control"
                                                                  id="editor">{!! $registrar->bio !!}</textarea>
                                                    </div>
                                                </div>
