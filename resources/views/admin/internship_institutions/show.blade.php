                                        ...
                                        <div class="col-xxl-12">
                                            <div class="card border card-border-primary">
                                                <div class="card-header">
                                                    ...
                                                    <h6 class="card-title mb-0">name {{$committee->name}}
                                                    <p class="card-title mb-0">section {{$committee->section}}
                                                ...
                                                <div class="card-body">
                                                    <div class="text-left">
                                                        <a href="{{url('/admin/committee/'.$committee->id.'/edit')}}" class="link-primary fw-medium">
