            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Internship Teaching Institution</h4>
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <a href="{{url('/admin/internship_institution')}}" class="btn btn-info add-btn"><i
                ...
                <div class="col-xxl-9">
                    <div class="card" id="companyList">
                        <div style="color: black;font-size: 18px;font-weight: bolder;" class="card-header">
                            Edit: {{$internship_institution->name}}
                        </div>
                            ...
                            <div class="col-xxl-9">
                                <div class="card" id="companyList">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="{{url('/admin/internship_institution/'.$internship_institution->id)}}"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="name"
                                                               value="{{$internship_institution->name}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="address"
                                                               value="{{$internship_institution->address}}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="website_link"
                                                               value="{{$internship_institution->website_link}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="hstack gap-2 justify-content-end">
                                                        ...
                                                        <button type="submit" class="btn btn-success">Update Internship Teaching Institution
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
