            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Internship Teaching Institutions</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">CRM</a></li>
                                <li class="breadcrumb-item registrarive">Internship Teaching Institutions</li>
                            </ol>
                        </div>
                            ...
                            <div class="col-sm-auto {{--ms-auto--}}">
                                <div class="list-grid-nav hstack gap-1">
                                    ...
                                    <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#addmembers">
                                        <i class="ri-add-fill me-1 align-bottom"></i> Add Internship Teaching Institution
                                    </button>
                                </div>
                            </div>
                            <!--end col-->
                                ...
                                <table class="table align-middle table-nowrap mb-0">
                                    ...
                                    @foreach($internship_institutions as $internship_institution)
                                        <tr>
                                            ...
                                            <td class="owner">{{$internship_institution->name}}</td>
                                            <td class="owner">{{$internship_institution->address}}</td>
                                            <td class="owner">Website Link: <a href="{{$internship_institution->website_link}}" target="_blank"> {{$internship_institution->website_link}}</a></td>
                                            <td>
                                                <ul class="list-inline hstack gap-2 mb-0">
                                                    <li class="list-inline-item" data-bs-toggle="tooltip"
                                                        ...
                                                        <a class="edit-item-btn"
                                                           href="{{url('/admin/internship_institution/'.$internship_institution->id.'/edit')}}">Edit</a>
                                                    </li>
                                                </ul>
                                            </td>
                                        </tr>
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="myModalLabel">Add Internship Teaching Institution</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <form method="post" action="{{url('/admin/internship_institution')}}"
