                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <a href="{{url('/admin/brands/create')}}" class="btn btn-info add-btn" ><i
                                ...
                                <div class="table-responsive table-card mb-3">
                                    <table class="table align-middle table-nowrap mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="name" scope="col">Brand</th>
                                        ...
                                        @foreach($brands as $brand)
                                            <tr>
                                                ...
                                                <td class="owner">{{$brand->name}}</td>
                                                <td class="owner">{!! $brand->description !!}</td>
                                                <td>
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        ...
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            <a class="edit-item-btn"
                                                               href="{{url('/admin/brands/'.$brand->id.'/edit')}}"><i
