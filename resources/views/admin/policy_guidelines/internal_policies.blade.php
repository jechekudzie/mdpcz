            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Internal POLICIES & GUIDELINES</h4>
                            ...
                            <div>
                                <div class="table-responsive table-card mb-3">
                                    <table id="example" class="table align-middle table-nowrap mb-0">
                                        ...
                                        @foreach($internal_policies as $internal_policie)
                                            <tr>
                                                <td class="owner">{{$internal_policie->title}}</td>
                                                <td class="owner">{{$internal_policie->committee->name}}</td>
                                                <td class="owner"><a href="{{url($internal_policie->file)}}" target="_blank">Policy</a>
                                                </td>
                                                <td>
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            title="View">
                                                            <a href="{{url($internal_policie->file)}}" target="_blank"
                                                        ...
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            <a class="edit-item-btn"
                                                               href="{{url('/admin/policy_guideline/'.$internal_policie->id.'/edit')}}">Edit</a>
                                                        </li>
                                                    </ul>
                                                </td>
                                            </tr>
