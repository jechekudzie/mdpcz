                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <a href="{{url('/admin/policy_guideline/'.$committee->id.'/index')}}" class="btn btn-info add-btn"><i
                ...
                <div class="col-xxl-9">
                    <div class="card" id="companyList">
                        <div style="color: black;font-size: 18px;font-weight: bolder;" class="card-header">
                            Add {{$committee->name}} (POLICIES & GUIDELINES)
                        </div>

                        <div class="card-body">

                            <form method="post" action="{{url('/admin/policy_guideline/'.$committee->id.'/store')}}"
                                ...
                                <div class="modal-footer">
                                    <div class="hstack gap-2 justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-success" id="add-btn">Add Policy guideline
                                        </button>
