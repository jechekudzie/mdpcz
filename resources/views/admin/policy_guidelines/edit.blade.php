                            ...
                            <div class="col-xxl-9">
                                <div class="card" id="companyList">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="{{url('/admin/policy_guideline/'.$policy_guideline->id)}}"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <a href="{{url($policy_guideline->file)}}" target="_blank">View current file</a>
                                            ...
                                            <div class="modal-footer">
                                                <div class="hstack gap-2 justify-content-end">
                                                    ...
                                                    <button type="submit" class="btn btn-success" id="add-btn">Update Policy & Guideline
                                                    </button>
