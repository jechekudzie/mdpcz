                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <a href="{{url('/admin/form/'.$form->form_category->id.'/index')}}" class="btn btn-info add-btn"><i
                            ...
                            <div class="col-xxl-9">
                                <div class="card" id="companyList">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="{{url('/admin/form/'.$form->id.'/update')}}"
                                            ...
                                            <div class="row">
                                                ...
                                                <a  href="{{asset($form->file)}}" target="_blank">View current file</a>
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="hstack gap-2 {{--justify-content-end--}}">
                                                        <button type="submit" class="btn btn-success">Update Form
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="{{url('/admin/form/'.$form->id.'/destroy')}}"
                                              enctype="multipart/form-data">
                                            @method('DELETE')
                                            @csrf
                                            <div class="row">
